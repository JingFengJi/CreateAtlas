...
static public class NGUIContextMenu
{
	...
	static public void AddCommonItems (GameObject target)
	{
		if (target != null)
		{
			...
			if(transform != null)
			{
				AddItem("Transform/Reset Position", false, OnResetPosition, target);
				AddItem("Transform/Reset Rotation", false, OnResetRotation, target);
				AddItem("Transform/Reset Scale Size", false, OnResetScaleSize, target);
			}
	...
	private static void OnResetPosition(object obj)
	{
	...
	private static void OnResetRotation(object obj)
	{
		if(obj != null && obj is GameObject)
		{
	...
	private static void OnResetScaleSize(object obj)
	{
		if(obj != null && obj is UISprite)
		{
			(obj as GameObject).transform.localScale = Vector3.zero;
			(obj as GameObject).transform.localScale = Vector3.one;
		}
	}
	...
	static void AttachCollider (object obj)
	{
		if (Selection.activeGameObject != null)
		{
			for (int i = 0; i < Selection.gameObjects.Length; ++i)
			{
				...
				NGUITools.AddButtonScale(Selection.gameObjects[i]);
			}
		}		
	}
