...
public class UILabelInspector : UIWidgetInspector
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
			...
			NGUIEditorTools.DrawProperty("OutlineProDr",serializedObject,"mOutlineProDr");
			NGUIEditorTools.DrawProperty("PanelAlphaControl",serializedObject,"PanelAlphaControl");
