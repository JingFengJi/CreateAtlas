...
public class UIGrid : UIWidgetContainer
{
	...
	public List<Transform> GetChildList(Sorting sort)
	{
		...
		if (sort != Sorting.None && arrangement != Arrangement.CellSnap)
		{
			if (sort == Sorting.Alphabetic) list.Sort(SortByName);
			else if (sort == Sorting.Horizontal) list.Sort(SortHorizontal);
			else if (sort == Sorting.Vertical) list.Sort(SortVertical);
			else if (onCustomSort != null) list.Sort(onCustomSort);
			else if (sort == Sorting.Numberic) list.Sort(UIGrid.SortNumeric);
			else Sort(list);
		}
		return list;
	}
	...
	public List<Transform> GetChildList ()
	{
		...
		if (sorting != Sorting.None && arrangement != Arrangement.CellSnap)
		{
			...
			else if (sorting == Sorting.Numberic) list.Sort(UIGrid.SortNumeric);
			else Sort(list);
		}
		return list;
	}
